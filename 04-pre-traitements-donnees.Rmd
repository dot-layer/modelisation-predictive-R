...
Dans cette section, nous verrons comment appliquer les concepts théoriques décrits dans la section précédente dans un contexte où nous voulons pas seulement entraîner un modèle, mais aussi l'uitiliser pour prédire de nouvelles observations dans un contexte de production. Comme nous l'avons vu, les prétraitements de données permettent de rendre les données d'entraînement compatibles et propices à l'apprentissage. Un fois que le modèle est entraîné, nous devons répliquer ces prétraitements sur les nouvelles observations de la même manière que nous l'avons fait sur le jeu de données d'entraînement. Dans cette optique, il faudra garder une trace de ces prétraitements 
