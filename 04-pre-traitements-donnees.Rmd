...
$$
où $\min_A = \min_i x_{i,A}$ et $\max_A  = \max_i x_{i,A}$ sont calculés sur la distribution de l'attribut $A$, alors que $new\_max_A$ et $new\_min_A$ correspondent aux bornes du nouvel intervalle désiré. 
